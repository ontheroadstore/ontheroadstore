        ...
        <section class="store-list">
          ...
          <el-row>
            ...
            <el-col :span="24">
              ...
              <!-- <el-pagination class="pagination" layout="prev, pager, next"  :current-page="pagination.current" :total="pagination.total" :page-size="pagination.size" @current-change="currentChange"></el-pagination> -->
            </el-col>
          </el-row>
        </section>
      </el-col>

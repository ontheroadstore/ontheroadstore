...
export default {
  ...
  mutations: {
    [types.OPTION_SET_MOBILE_LAYOUT]: (state, data) => {
      Vue.set(state.globalOption, 'isMobile', data)
    },
    [types.OPTION_SET_GLOBAL]: (state, data) => {
      Vue.set(state.globalOption, data.type, data.value)
    },
    [types.OPTION_SET_INFINITE]: (state, data) => {
      Vue.set(state.infiniteScroll, 'callback', data)
    },
    [types.OPTION_SET_INFINTE_LOADING]: (state, data) => {
      Vue.set(state.infiniteScroll, 'loading', data)
    }
  },
  actions: {
    [types.SEARCH_DIALOG_SHOW]: ({commit}) => {
      commit(types.OPTION_SET_GLOBAL, {
        type: 'searchDialogDisplay',
        value: true
      })
    },
    [types.SEARCH_DIALOG_HIDE]: ({commit}) => {
      commit(types.OPTION_SET_GLOBAL, {
        type: 'searchDialogDisplay',
        value: false
      })
    },
    [types.OPTION_INFINITE_SCROLL]: ({commit}, data) => {
      commit(types.OPTION_SET_INFINITE, () => {
    ...
    [types.OPTION_INFINTE_LOADING]: ({commit}, data) => {
      commit(types.OPTION_SET_INFINTE_LOADING, data)
    }
  },
  getters: {
    [types.OPTION_GET_GLOBAL]: (state) => {
      return state.globalOption
    },
    [types.OPTION_GET_INFINITE_SCROLL]: (state) => {
